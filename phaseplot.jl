...
#Set end-dates for the various waves and filter the original data to those dates
...
scatter!(a, [last_value.newAdmissions], [last_value.hospitalCases], marker = :x, markersize = 4, markercolor = :black, label = "Latest")
